...
// This is the more complicated way of writing the Header component; follow Header format
...
export default function ManualHeader() {
    const { enableWeb3, isWeb3Enabled, isWeb3EnableLoading, account, Moralis, deactivateWeb3 } =
        useMoralis() // useMoralis is a React hook which will store blockchain states
